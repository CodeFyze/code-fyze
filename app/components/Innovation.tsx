export default function Innovation() {
  return (
    <div className="flex w-screen h-full px-10 lg:px-[10vw] py-11 md:py-32 mt-11 bg-contain bg-no-repeat bg-innovationBgVertical sm:bg-innovationBg sm:bg-cover bg-center">
