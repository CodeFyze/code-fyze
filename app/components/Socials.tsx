...
export default function Socials() {
 ...
 const handleEmailClick = () => {
  ...
  <a
    ...
    className="text-[#0E3172] hover:text-[#0E3172] transition-colors duration-300 bg-white rounded-full p-2 m-2 flex items-center justify-center z-10"
  >
  ...
  <span className="pointer-events-none absolute inset-0 flex items-center justify-center">
    <span className="pointer-events-none absolute w-full h-full rounded-full border-2 border-[#0E3172] animate-pulse-ring"></span>
    <span className="pointer-events-none absolute w-full h-full rounded-full border-2 border-[#0E3172] animate-pulse-ring delay-75"></span>
  </span>
</div>
