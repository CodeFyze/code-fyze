...
export const homeFAQs: faqs = {
  heading: "Welcome to Our Home Page FAQ Section",
  subheading:
  ...
  questions: [
    ...
    },
    {
      ...
      answer:
        "Yes, we offer flexible service bundles to meet your specific business needs.",
    },
    {
      question: "How do you protect data?",
      answer:
        "We use advanced encryption, firewalls, and regular security audits to protect your data.",
    },
    {
      question: "How do you ensure data security?",
      answer:
        "Our team implements best practices, including secure coding and regular vulnerability assessments, to ensure your data remains secure.",
    },
  ],
};

export const landingFAQs: faqs = {
  heading:
    "Frequently Asked Questions (FAQs) Landing Page Design Agency Solutions",
  subheading: "Everything You Need to Know About Our IT Services",
  questions: [
    {
    ...
    {
      question:
        "How do you ensure my landing page is optimized for search engines (SEO)?",
      answer:
    ...
    {
      question:
        "Can you integrate my landing page with my existing website or CRM system?",
      answer:
