    ...
    <main className="flex flex-col items-center justify-center w-screen gap-4">
      ...
      <section className="w-full h-max space-y-2 my-6">
        ...
        <header className="flex justify-center my-6">
          <div className="heading flex flex-col items-center w-4/6 lg:w-10/12 sm:gap-2">
            <p className=" font-extrabold sm:font-bold text-[#0E3172] text-center text-[4vw] md:text-3xl">
              Technologies We Used
            </p>
            <p className="font-medium text-center text-[2vw] md:text-sm">
        ...
        {/* Cards */}
        <div className="w-full h-max md:h-max bg-blueBg bg-cover">
      ...
      <section className="w-full">
        <div className="w-full h-max bg-whiteBg bg-cover py-8">
