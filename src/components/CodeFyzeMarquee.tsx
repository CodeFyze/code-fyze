...
export function CodeFyzeMarquee() {
  ...
  return (
    <div className="relative flex h-10 mb-0 w-full flex-col items-center justify-center overflow-hidden bg-slate-300 bg-opacity-70 backdrop-blur-sm">
      <Marquee pauseOnHover className="[--duration:20s]">
        ...
        {Array.from({ length: 16 }).map((_, i) => (
          <img
            ...
            src={`/icons/${i + 1}.png`}
            alt={`logo ${i + 1}`}
            className="w-auto h-6 mx-4 block object-contain"
          />
        ))}
        {/* <img
          src="/logo.png"
