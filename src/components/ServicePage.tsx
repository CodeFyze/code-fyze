        ...
        <div className="">
          <div className="gap-6 flex flex-col items-center">
            {constants.map((item, index) => (
              <motion.div
                key={index}
                className={`w-4/5 h-96 rounded-xl overflow-hidden shadow-lg bg-white bg-opacity-90 flex max-md:flex-col-reverse items-center ${index % 2 !== 0 ? "md:flex-row-reverse" : ""}`}
